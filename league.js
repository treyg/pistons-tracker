...
.then((leagueNewsJSON) => {
  ...
  const showLeagueNews = () => {
      ...
      let leagueImgContainer = document.createElement('div')
        ...
        leagueImgContainer.classList.add('flex', 'flex-col', 'py-2', 'overflow-hidden', 'mb-6', 'border-2', 'border-gray-200', 'rounded', 'cursor-pointer')
        ...
        leagueNewsTitle.classList.add('mx-3', 'text-base', 'mt-2', 'font-medium')
        ...
        if (leagueNewsProvider.textContent == undefined) {
          leagueNewsProvider.textContent.classList.add('hidden')
        } 
